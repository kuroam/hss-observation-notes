...
This is a provisional memo of symbols used in HSS.
Here, only the minimum terms needed to read the README are placed.
The definitions are not fixed; they are treated as something that may be reconnected and reinterpreted while observation continues.

## About notation

The terminology in this document is provisional.

Notations such as Flow, symbol, Blue residuals, and 積層history are currently treated as symbols within the observation memo.
...
Reserved layers do not deny existence or importance; they refer to layers that are not explicitly formalized in the current version.

Emotion, bodily desire, neurophysiological response, passion, impulse, pleasure, pain, desire for recognition, and related phenomena may be positioned in these reserved layers.
