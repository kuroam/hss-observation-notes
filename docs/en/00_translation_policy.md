# 00. Translation Policy

The Japanese version is the canonical source.

The English version is a working translation / adaptation.
English terminology is provisional.

If there is ambiguity or conflict, the Japanese concept takes priority.

The English version must not introduce new HSS concepts that do not exist in the Japanese version.

HSS should be read as:

- a provisional observation memo
- a proof-of-concept observation model
- a coarse-grained structural scanner
...
- Prefer one stable English expression after a term has been introduced, instead of repeating multiple glosses every time.
- Use clear, reader-friendly headings consistently. Short section headings are acceptable when they improve navigation.
...
| Japanese | English |
| --- | --- |
| 継続接続 | continuous connection |
| 再接続 | reconnection |
| 再展開 | re-expansion |
| 固定化 | fixation |
| Blue residuals | Blue residuals |
...
- 積層history / layered history: The translation table keeps “layered history / stratified history (provisional)” to show the translation range. In running English prose, use “layered history” after the term has been introduced. “Stratified history” may appear as an auxiliary gloss when the translation range itself is being discussed. Do not repeatedly write “layered history / stratified history” unless the translation range itself is being discussed. This does not affect “stratified routing,” which is a separate HSS term.
