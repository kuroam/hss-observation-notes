...
HSSでは、L1〜L3で生じた接触、反応、痕跡、処理形式が、外から接続構造として観測しやすくなる領域をL4〜L6として扱います。

このため、HSSはL1〜L3を背景に置きつつ、継続接続、積層history、圧縮されたsymbol、固定化、再接続、再展開として見え始めるL4〜L6付近を中核的な観測領域とします。
...
- 継続接続 → 積層history
- 時間、反復、記憶、関係性、運用、違和感が重なると、履歴として観測されやすい。
