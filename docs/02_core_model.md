...
L1〜L3は、媒体、制度、物理基盤、言語基盤、プラットフォーム環境など、接続が成立するための下位基盤に関わる可能性があります。

ただし、現行版のHSSでは、これらを明示的な階層として定義しません。

これは、HSSを過度に固定化された階層モデルにしないためです。

感情、身体的欲求、脳生理的反応、情熱、衝動などは、より深い層に位置づけられる可能性がありますが、このメモでは明示的なモデル対象とはしません。

この文書では、あくまでL4〜L6付近に見える接続・圧縮・再接続・再展開の循環を観測対象とします。
